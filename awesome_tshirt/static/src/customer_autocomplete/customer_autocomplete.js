        ...
        return [
            {
                ...
                options: this.loadOptionSources.bind(this),
            }
        ]
    }

    async loadOptionSources(request){
        if(!this.partners){
        ...
        const fuzzySearch = fuzzyLookup(request, this.partners, (parther) => this.partners.label).slice(0,8);
